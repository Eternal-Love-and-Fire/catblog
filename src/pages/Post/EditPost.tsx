...
export function EditPost() {
  ...
  const [markdownContent, setMarkdownContent] = useState({text: "asdasd", image: undefined});

//   useEffect(() => {
//     axios.get("https://your-api-endpoint.com/post").then((response) => {
//       const parsedHTML = parseDocument(response.data.markdownContent);
//       setMarkdownContent(parsedHTML);
//     });
//   }, []);
